...
CFpsSoliderPlayer::CFpsSoliderPlayer(const char* Name, Physics::IPhysicsStrategy* PhysicsStrategy) 
	: CPlayer(Name, PhysicsStrategy)
{
	...
	m_SightNode = m_PlayerNode->createChildSceneNode (String(Name) + "_sight", reVector3Df(0, 0, 0));
	m_CameraNode = m_PlayerNode->createChildSceneNode (String(Name) + "_camera", reVector3Df(0, 0, 0));
