...
//
//
//int Core::AI::SimpleVehicle::serialNumberCounter = 0;
//
//
//// ----------------------------------------------------------------------------
//// constructor
//
//
//Core::AI::SimpleVehicle::SimpleVehicle (void)
//{
//    // set inital state
//    reset ();
//
...
//
//reVector3Df 
//Core::AI::SimpleVehicle::adjustRawSteeringForce (const reVector3Df& force,
//                                                  const float /* deltaTime */)
//{
//    const float maxAdjustedSpeed = 0.2f * maxSpeed ();
//
//    if ((speed () > maxAdjustedSpeed) || (force == reVector3Df::ZERO))
//    {
//        return force;
//    }
//    else
...
//
//void 
//Core::AI::SimpleVehicle::applyBrakingForce (const float rate, const float deltaTime)
//{
...
//
//void 
//Core::AI::SimpleVehicle::ApplySteeringForce (const reVector3Df& force,
//                                              const float elapsedTime)
//{
//
//    const reVector3Df adjustedForce = adjustRawSteeringForce (force, elapsedTime);
//
//    // enforce limit on magnitude of steering force
//    const reVector3Df clippedForce = adjustedForce.truncateLength (maxForce ());
//
//    // compute acceleration and velocity
//    reVector3Df newAcceleration = (clippedForce / mass());
//    reVector3Df newVelocity = velocity();
//
...
//
//void 
//Core::AI::SimpleVehicle::regenerateLocalSpace (const reVector3Df& newVelocity,
//                                                const float /* elapsedTime */)
//{
...
//
//void 
//Core::AI::SimpleVehicle::regenerateLocalSpaceForBanking (const reVector3Df& newVelocity,
//                                                          const float elapsedTime)
//{
//    // the length of this global-upward-pointing vector controls the vehicle's
//    // tendency to right itself as it is rolled over from turning acceleration
//    const reVector3Df globalUp (0, 0.2f, 0);
//
//    // acceleration points toward the center of local path Curvature, the
//    // length determines how much the vehicle will roll while turning
//    const reVector3Df accelUp = _smoothedAcceleration * 0.05f;
//
//    // combined banking, sum of UP due to turning and global UP
//    const reVector3Df bankUp = accelUp + globalUp;
//
...
//
////  annotationLine (position(), position() + (globalUp * 4), Color::gWhite);  // XXX
////  annotationLine (position(), position() + (bankUp   * 4), Color::gOrange); // XXX
////  annotationLine (position(), position() + (accelUp  * 4), Color::gRed);    // XXX
////  annotationLine (position(), position() + (up ()    * 1), Color::gYellow); // XXX
//
//    // adjust orthonormal basis vectors to be aligned with new velocity
//    if (speed() > 0) regenerateOrthonormalBasisUF (newVelocity / speed());
//}
...
//
//void 
//Core::AI::SimpleVehicle::measurePathCurvature (const float elapsedTime)
//{
//    if (elapsedTime > 0)
//    {
//        const reVector3Df dP = _lastPosition - position ();
//        const reVector3Df dF = (_lastForward - forward ()) / dP.length ();
//        const reVector3Df lateral = dF.perpendicularComponent (forward ());
...
//
//void 
//Core::AI::SimpleVehicle::annotationVelocityAcceleration (float maxLengthA, 
//                                                          float maxLengthV)
//{
...
//
//reVector3Df 
//Core::AI::SimpleVehicle::predictFuturePosition (const float predictionTime) const
//{
