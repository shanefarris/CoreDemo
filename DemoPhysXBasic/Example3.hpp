...
class Example3Listener : public ExampleFrameListener
{ 
public:
    Example3Listener(RenderWindow *win, Camera *cam) 
...
class Example3 : public ExampleApplication, public NxOgre::Callback
{
protected:
    NxOgre::World*            mWorld;
    NxOgre::Scene*            mScene;
    ...
    void createScene()
    {
        ...
        // Add objects
        mCube = mRenderSystem->createBody(new NxOgre::Box(1, 1, 1), NxOgre::Vec3(0, 10, 0), "cube.1m.mesh");
    ...
    {
        mFrameListener = new Example3Listener(mWindow, mCamera);
