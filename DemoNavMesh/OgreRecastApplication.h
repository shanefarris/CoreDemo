...
/**
  ...
  **/
class OgreRecastApplication : public Core::CGameState, public FrameListener, public WindowEventListener, public OIS::MouseListener, public OIS::KeyListener
{
public:
    ...
    /**
      ...
      **/
    virtual bool queryCursorPosition(Ogre::Vector3 &rayHitPoint, unsigned long queryflags, bool clipToNavmesh = true, Ogre::MovableObject **rayHitObject = NULL);
